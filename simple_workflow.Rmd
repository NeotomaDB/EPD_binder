...
## saveRDS(quebec_dl, "data/afDownload.RDS")
quebec_dl <- readRDS("data/afDownload.RDS")
```
...
```{r PlotTaxonCountsFirst, echo=FALSE, fig.cap="**Figure**. *A plot of the number of sites a taxon appears in, against the number of samples a taxon appears in.*", message=FALSE}
taxaplots <- taxa(quebec_dl)
